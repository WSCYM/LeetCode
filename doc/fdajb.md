...
+ HashSet存储的元素必须重写hashCode()和equals()。
...
在**JDK1.5**之后，如果我们定义一个方法需要接受多个参数，并且多个参数类型一致（前提是知道参数类型），我们可以对其简化成如下格式：
...
+ int compare(T o1, T o2)方法 返回值<0 即 o1<o2
+ int compare(T o1, T o2)方法 返回值=0 即 o1=o2
+ int compare(T o1, T o2)方法 返回值>0 即 o1>o2